 ...
 */
public class Reportes_limpieza extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reportes_limpieza);
        ...
        btnstart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ParseObject testObject = new ParseObject("Limpieza");
                ...
                testObject.saveInBackground(new SaveCallback() {
                    public void done(ParseException e) {
                        finish();
                        if (e == null) {
                            Toast.makeText(Reportes_limpieza.this, "Enviado Correctamente", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(Reportes_limpieza.this, "Envio de reporte fallido, Vuelve a intentarlo", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
