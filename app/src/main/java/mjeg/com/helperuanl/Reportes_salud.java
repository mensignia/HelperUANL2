 ...
 */
public class Reportes_salud extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reportes_salud);
        ...
        btnstart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ParseObject testObject = new ParseObject("Emergencia_Medica");
                ...
                testObject.saveInBackground(new SaveCallback() {
                    public void done(ParseException e) {
                        finish();
                        if (e == null) {
                            Toast.makeText(Reportes_salud.this, "Enviado Correctamente", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(Reportes_salud.this, "Envio de reporte fallido, Vuelve a intentarlo", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
